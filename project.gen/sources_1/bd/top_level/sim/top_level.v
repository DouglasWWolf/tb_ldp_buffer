...
module ldp_buffer_imp_1XQO3A8
  ...
  top_level_ldp_buffer_0_0 ldp_buffer
       (.axis_fd_in_tdata(example_slave_axis_out_TDATA),
        ...
        .axis_md_in_tdata({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .axis_md_in_tvalid(1'b0),
        .axis_md_out_tready(1'b1),
